...
# Se desejar, aqui também entra o arquivo com o GA, por exemplo:
# source("scripts/ga_selecao_variaveis.R")
...
# limiar de decisão, utiliza-se a tabela de limiares produzida pela
# função de avaliação padronizada. Essa tabela relaciona, em dados de
...
metr_teste_agressivo <- calcula_metricas(
  y_teste,
  prob_teste,
  limiar_agressivo
)
